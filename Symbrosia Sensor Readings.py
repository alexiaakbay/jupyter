...
def main():
    ...
    #device1.set_i2c_address(97)
	#device2.set_i2c_address(99)
	#device3.set_i2c_address(100)
	#device4.set_i2c_address(102)

	csv = open("/home/pi/atlas_i2c_pH_sensor.csv","a")
    device = AtlasI2C()     # creates the I2C port object, specify the address or bus if necessary
	...
	#while True:
		#history = []
		#hoge = float(string.split(2.0, '1')[1])
		#history.append(hoge)
		#print(hoge)
		#print(history)


        #git = plt.figure(figsize=(10,10))
        #plt.title("Ru's dissolved oxygen sensor")
        ...
        #plt.plot(x_arr, y1_arr, lab = "DO sensor")
